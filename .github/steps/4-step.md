...
1. **Copilot Chat** 패널을 열고 **Plan Agent**로 전환합니다.
   ...
   <img width="350" alt="image" src="https://github.com/h0117er/getting-started-with-github-copilot-ko/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. 제안된 계획을 검토하고 만족하면 **Start implementation**을 눌러 **Agent Mode**로 넘깁니다.
   ...
   <img width="350" alt="image" src="https://github.com/h0117er/getting-started-with-github-copilot-ko/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
